...
<div class="cliente-form">
    ...
    <?php //$form->field($model, 'municipio.cod_uf')->listBox(['1'=>'Paraná']) ?>
    <?= $form->field($model, 'cod_uf_aux')->listBox(yii\helpers\ArrayHelper::map(app\models\Uf::find()->all(), 'cod_uf', 'nome_uf'), ['multiple'=>false,'size'=>1, 'prompt'=>'Selecione a UF']) ?>    
    <?= $form->field($model, 'cod_mun')->listBox(yii\helpers\ArrayHelper::map(app\models\Municipio::find()->all(), 'cod_mun', 'nome_mun'), ['multiple'=>false,'size'=>1, 'prompt'=>'Selecione o Município']) ?>
