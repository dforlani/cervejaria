                    ...
                    <div class="col-md-2" style="">
                        ...
                        echo SideNav::widget([
                            ...
                            'items' => [
                                ...
                                ['label' => 'Comandas', 'url' => ['/comanda/index']],
                                ['label' => 'Cervejas', 'url' => ['/produto/cerveja']],
                                ['label' => 'Outros Produtos', 'url' => ['/produto/index']],
                                ['label' => 'Unidades de Medida', 'url' => ['/unidade-medida/index']],
                                ['label' => 'Pedidos Aplicativo', 'url' => ['/pedidoapp/index']],
                                ['options' => ['style' => 'background-color:#ddd;margin-top: 0px;']],
                                ...
                                ['options' => ['style' => 'background-color:#ddd;margin-top: 0px;']],
                                ['label' => 'Configuração', 'url' => ['/configuracao/index']],
