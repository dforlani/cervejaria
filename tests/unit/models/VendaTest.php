...
class VendaTest extends Unit {
    ...
    public function testCriacaoItemVenda() {
        ...
        $produto->custo_compra_producao = 2;
        ...
        //teste do valor calculado automaticamente preco_custo_item
        $this->assertEquals($item->preco_custo_item, $item->preco->produto->custo_compra_producao * $item->preco->quantidade  * $item->quantidade);
